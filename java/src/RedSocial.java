...
public class RedSocial {
    ...
    private void cargarDatosPrueba() {
        ...
        et.add(Etiqueta.MUSICA);

        publicaciones.add(new PublicacionTexto(u1, "Hola mundo desde Java", et));
        publicaciones.add(new PublicacionTexto(u2, "Me gusta la música", et));
    }
}